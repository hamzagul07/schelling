...
| E-LEDGER-challenge-v1 | 8. Ledger | Sealed challenge v1 median | 34.576 | `FORECASTS.md` | `8591c3a` | frozen 2026-07-21; sha256 aece91bdcfd8… (gitignored — commit-reveal) |
| E-LEDGER-compromise-v1 | 8. Ledger | Sealed compromise v1 median | 41.636 | `FORECASTS.md` | `8591c3a` | frozen 2026-07-21; sha256 c87d91ae7f05… (gitignored — commit-reveal) |
| E-LEDGER-challenge-v2 | 8. Ledger | Sealed challenge v2 median | 29.407 | `FORECASTS.md` | `8591c3a` | frozen 2026-07-21; sha256 3bc97cd4a4ba… (gitignored — commit-reveal) |
| E-LEDGER-compromise-v2 | 8. Ledger | Sealed compromise v2 median | 39.443 | `FORECASTS.md` | `8591c3a` | frozen 2026-07-21; sha256 d55ffc3e78fc… (gitignored — commit-reveal) |
...
| E-TESTS | Repro | Test count (pytest --collect-only) | 297 | `tests/` | `0c2e6fa` | regenerated live; green gate is the acceptance bar |
